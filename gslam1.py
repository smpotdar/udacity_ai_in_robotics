# -*- coding: utf-8 -*-
"""
Created on Sat Dec 05 11:40:27 2015
...
def doit(initial_pos, move1, move2):
    ...
    move=[]
    move.append(initial_pos)
    move.append(move1)
    move.append(move2)
    
    move_2=[]
    move_2.append(initial_pos)
    move_2.append(-move1)
    move_2.append(move1)
    move_2.append(-move2)
    move_2.append(move2)    
    omega=[[-1 for col in range(len(move))] for row in range(len(move))]
    xhy=[0 for row in range(3)]    
